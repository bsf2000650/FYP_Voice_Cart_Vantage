const styles = {
  ...
  shop_name: "p-0 text-[15px] text-blue-400",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
  button:
    "w-[150px] bg-[#ff7f29] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[#ff7f29] flex items-center justify-center cursor-pointer",
